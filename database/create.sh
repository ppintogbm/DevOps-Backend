...
su - db2inst1 -c 'db2 connect to test'
su - db2inst1 -c 'db2 "CREATE TABLE OPER01
...
su - db2inst1 -c 'db2 connect to test'
su - db2inst1 -c 'db2 list tables'
su - db2inst1 -c 'db2 describe table db2inst1.oper01'
su - db2inst1 -c 'db2 disconnect test'